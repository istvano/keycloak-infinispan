...
$(eval $(call defw,CA_TLS_FILE,$(MFILECWD)/tmp/localhost-ca.pem))
$(eval $(call defw,CA_TLS_KEY,$(MFILECWD)/tmp/localhost-ca-key.pem))
$(eval $(call defw,TLS_FILE,$(MFILECWD)/tmp/server.pem))
$(eval $(call defw,TLS_KEY,$(MFILECWD)/tmp/server-key.pem))
$(eval $(call defw,TLS_CSR,$(MFILECWD)/tmp/server.csr))
